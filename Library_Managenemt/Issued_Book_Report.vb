...
Public Class Issued_Book_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Library_Managenemt.Issued_Book_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssued_Book_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Issued_Book_Report = New Issued_Book_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
